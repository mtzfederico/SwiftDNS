...
struct TestDNSError {
    ...
    @Test func testDNSError_Equatable() async throws {
        ...
        #expect(DNSError.unknownState(nil) != DNSError.noAnswer)
        ...
        #expect(DNSError.unknownState(nil) != DNSError.connectionFailed(DNSError.noAnswer))
        ...
        #expect(DNSError.noAnswer != DNSError.unknownState(nil))
        #expect(DNSError.noAnswer != DNSError.unknownState(.preparing))
