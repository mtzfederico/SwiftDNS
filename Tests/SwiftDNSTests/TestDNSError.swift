...
struct TestDNSError {
    ...
    @Test func testDNSError_Equatable() async throws {
        ...
        #expect(DNSError.invalidData != DNSError.invalidResponse)
        ...
        #expect(DNSError.connectionIsNil != DNSError.invalidResponse)
        ...
        #expect(DNSError.invalidServerAddress != DNSError.invalidResponse)
        ...
        #expect(DNSError.parsingError(nil) != DNSError.invalidResponse)
        ...
        #expect(DNSError.invalidResponse != DNSError.invalidData)
        #expect(DNSError.invalidResponse != DNSError.unknownState)
        #expect(DNSError.invalidResponse != DNSError.noAnswer)
        #expect(DNSError.invalidResponse != DNSError.noDataReceived)
        #expect(DNSError.invalidResponse == DNSError.invalidResponse)
        #expect(DNSError.invalidResponse != DNSError.connectionIsNil)
        #expect(DNSError.invalidResponse != DNSError.invalidServerAddress)
        #expect(DNSError.invalidResponse != DNSError.connectionFailed(DNSError.noAnswer))
        #expect(DNSError.invalidResponse != DNSError.parsingError(nil))
        #expect(DNSError.invalidResponse != DNSError.parsingError(DNSError.noDataReceived))
        ...
        #expect(DNSError.unknownState != DNSError.invalidResponse)
        ...
        #expect(DNSError.connectionFailed(DNSError.noDataReceived) != DNSError.invalidResponse)
        ...
        #expect(DNSError.noDataReceived != DNSError.invalidResponse)
        ...
        #expect(DNSError.noAnswer != DNSError.invalidResponse)
